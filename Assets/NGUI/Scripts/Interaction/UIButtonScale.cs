...
public class UIButtonScale : MonoBehaviour
{
    ...
    public Vector3 pressed = new Vector3(0.95f, 0.95f, 0.95f); //add by Timorkong (1.01f,1.01f,1.01f) to (0.95f, 0.95f, 0.95f)
	public float duration = 0.01f; //add by Timorkong 0.2 to 0.01
