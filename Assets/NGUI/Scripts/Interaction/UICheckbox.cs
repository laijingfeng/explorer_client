    ...
    public bool isEnabled
    {
        ...
        set
        {
            ...
            if (col.enabled != value)
            {
                ...
                Color c = value ? Color.white : Color.gray;

                GameObject Background = Util.Find(gameObject, "Background");
                if (Background)
                {
                    TweenColor tc = TweenColor.Begin(Background, 0.15f, c);
                    tc.color = c;
                    tc.enabled = false;
                }

                GameObject Label = Util.Find(gameObject, "Label");
                if (Label)
                {
                    TweenColor tc = TweenColor.Begin(Label, 0.15f, c);
                    tc.color = c;
                    tc.enabled = false;
                }
