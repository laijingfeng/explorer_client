...
#region 贴图路径[Added By : Jerrylai 2014-09-01 10:29:28]
		...
		get
		{
			if (!mCreatingMat && mMat == null)
			{
				...
				if (mainTexture != null)
				{
                    ...
                    {
                        mDynamicMat.SetTexture("_AlphaTex", mTextureMask);
                    }
				}
    ...
    //[HideInInspector] 
    //[SerializeField]
    public Texture mTextureMask;
    public Texture TextureMask
    {
        get { return mTextureMask; }
        set
        {
            if (mMat == null)
            {
            ...
            //Debug.Log(value);
            mMat.SetTexture("_AlphaTex", value);
            mTextureMask = value;
        }
    }
