	...
	public void UpdateUVs (bool force)
	{
			...
			))
		{
			...
			if (tex != null)
			{
                ...
                //[Jerrylai_2014-11-26 13:54:26_start]
                mOuter = new Rect( mSprite.outer.xMin + mSprite.cutBorderLeft , mSprite.outer.yMin + mSprite.cutBorderTop , mSprite.outer.width - ( mSprite.cutBorderLeft + mSprite.cutBorderRight ) , mSprite.outer.height - ( mSprite.cutBorderTop + mSprite.cutBorderBottom ) );//new code
                //mOuter = mSprite.outer;//old code
                //[Jerrylai_2014-11-26 13:54:26_end]
