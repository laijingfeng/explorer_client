...
public class UIInput : MonoBehaviour
{
	...
	void Update ()
	{
        ...
        if (selected && textEditor != null)
        {
            if ((Application.isWebPlayer && (Input.GetKey(KeyCode.RightControl) || Input.GetKey(KeyCode.LeftControl)) && Input.GetKeyDown(KeyCode.V))
                || (Application.isEditor && (Input.GetKeyDown(KeyCode.RightControl) || Input.GetKeyDown(KeyCode.LeftControl)))
                )
            {
