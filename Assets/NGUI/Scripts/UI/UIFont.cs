...
public class UIFont : MonoBehaviour
{
    ...
    public float ttfSize = 12f;
    public float fontConstYOffset = 0f;
		...
		get
		{
            ...
            if (UseDynamicFont)
            {
                if (dynamicFontMaterial != null)
                {
                    ...
                    // Add by Thomas Meng --- Test Solution to fix character opaque issue
                    //dynamicFontMaterial.mainTexture.filterMode = FilterMode.Point;
