...
public class UIEventListener : MonoBehaviour
{
    ...
    static public UIEventListener Get(Component comp)
    {
        UIEventListener listener = comp.gameObject.GetComponent<UIEventListener>();
        if (listener == null) listener = comp.gameObject.AddComponent<UIEventListener>();
        return listener;
    }
}