...
static public class NGUITools
{
	...
	static public GameObject AddChild (GameObject parent, GameObject prefab)
	{
		...
		if (go != null && parent != null)
		{
            ...
            // add by thomas meng
            // workaround : sometimes, prefab and instantiated game-object share the same material thus change one will change all texture;
            // Temporarily create seperate material for every UItexture; 
            Material mMat;
            UITexture[] texs = go.GetComponentsInChildren<UITexture>();
            foreach (UITexture tex in texs)
            {
                ...
                {
                    mMat = new Material(tex.material);
                }
                tex.material = mMat;
            }
		}
