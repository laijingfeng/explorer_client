...
public class UICreateWidgetWizard : EditorWindow
{
	...
	static void Save ()
	{
        ...
        SaveString("NGUI ButtonDisable", mButtonDisable);
	...
	static void Load ()
	{
        ...
        mButtonDisable = LoadString("NGUI ButtonDisable");
	...
	void CreateButton (GameObject go)
	{
		if (NGUISettings.atlas != null)
		{
            ...
            NGUIEditorTools.SpriteField("DisableBG", "Sliced Sprite for the DisableBG", NGUISettings.atlas, mButtonDisable, OnButtonDisable);
		}
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			bg.transform.localScale = new Vector3(150f, 50f, 1f);
			bg.MakePixelPerfect();

            UISprite disbg = NGUITools.AddWidget<UISprite>(go);
            disbg.type = UISprite.Type.Sliced;
            disbg.name = "DisableBG";
            disbg.depth = depth;
            disbg.atlas = NGUISettings.atlas;
            disbg.spriteName = mButtonDisable;
            disbg.transform.localScale = new Vector3(150f, 50f, 1f);
            disbg.MakePixelPerfect();
            disbg.gameObject.SetActive(false);
            ...
            go.GetComponent<UIButton>().disabledBG = disbg.gameObject;
    ...
    void OnButtonDisable(string val) { mButtonDisable = val; Save(); Repaint(); }
	...
	void CreateCheckbox (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			bg.transform.localScale = new Vector3(40f, 40f, 1f);
			bg.MakePixelPerfect();
            ...
            fg.transform.localScale = new Vector3(40f, 40f, 1f);
			fg.MakePixelPerfect();
			...
			if (NGUISettings.font != null)
			{
				...
				lbl.transform.localPosition = new Vector3(25f, 0f, 0f);
				lbl.MakePixelPerfect();
			}
