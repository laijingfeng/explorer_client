			...
			else
			{
				...
				if (!mConfirmDelete && mSprite != null)
				{
					...
					if (tex != null)
					{
                        ...
                        //Record Cut Border [Jerrylai_2014-11-26 11:51:16_start] 
                        int cutBorderLeft   = mSprite.cutBorderLeft;
                        int cutBorderRight  = mSprite.cutBorderRight;
                        int cutBorderTop    = mSprite.cutBorderTop;
                        int cutBorderBottom = mSprite.cutBorderBottom;
                        EditorGUILayout.Separator();
                        NGUIEditorTools.IntVector tmpCutBorderLeftTop = NGUIEditorTools.IntPair( "CutBorder" , "Left" , "Top" , cutBorderLeft , cutBorderTop );
                        NGUIEditorTools.IntVector tmpCutBorderRightBottom = NGUIEditorTools.IntPair( null , "Right" , "Bottom" , cutBorderRight , cutBorderBottom );
                        if ( cutBorderLeft != tmpCutBorderLeftTop.x || cutBorderTop != tmpCutBorderLeftTop.y || cutBorderRight != tmpCutBorderRightBottom.x || cutBorderBottom != tmpCutBorderRightBottom.y)
                        {
                            NGUIEditorTools.RegisterUndo( "Atlas Change" , mAtlas );
                            if ( tmpCutBorderLeftTop.x >= 0 && tmpCutBorderLeftTop.x <= mSprite.outer.width && ( tmpCutBorderLeftTop.x + tmpCutBorderRightBottom.x <= mSprite.outer.width ) )
                            {
                                mSprite.cutBorderLeft = tmpCutBorderLeftTop.x;
                            }
                            else
                            {
                                Debug.LogError( "UIAtlas Set CutBorder Error , Left Or Right Or Sum Over The Weight." + mSprite.outer.width );
                            }

                            if ( tmpCutBorderRightBottom.x >= 0 && tmpCutBorderRightBottom.x <= mSprite.outer.width && ( tmpCutBorderLeftTop.x + tmpCutBorderRightBottom.x <= mSprite.outer.width ) )
                            {
                                mSprite.cutBorderRight = tmpCutBorderRightBottom.x;
                            }
                            else
                            {
                                Debug.LogError( "UIAtlas Set CutBorder Error , Left Or Right Or Sum Over The Weight." );
                            }

                            if ( tmpCutBorderLeftTop.y >= 0 && tmpCutBorderLeftTop.y <= mSprite.outer.height && ( tmpCutBorderLeftTop.y + tmpCutBorderRightBottom.y <= mSprite.outer.height ) )
                            {
                                mSprite.cutBorderTop = tmpCutBorderLeftTop.y;
                            }
                            else
                            {
                                Debug.LogError( "UIAtlas Set CutBorder Error , Top Or Bottom Or Sum Over The Height." );
                            }

                            if ( tmpCutBorderRightBottom.y >= 0 && tmpCutBorderRightBottom.y <= mSprite.outer.height && ( tmpCutBorderLeftTop.y + tmpCutBorderRightBottom.y <= mSprite.outer.height ) )
                            {
                                mSprite.cutBorderBottom = tmpCutBorderRightBottom.y;
                            }
                            else
                            {
                                Debug.LogError( "UIAtlas Set CutBorder Error , Top Or Bottom Or Sum Over The Height.");
                        ...
                        //Record Cut Border [Jerrylai_2014-11-26 11:51:16_end]
					}
