...
public class UIPanelInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
        ...
        float interval = EditorGUILayout.Slider("Interval", panel.mUpdateInterval, 1f/1000f, 1f/33f);

        if (interval != panel.mUpdateInterval)
        {
            NGUIEditorTools.RegisterUndo("Panel Update", panel);
            panel.mUpdateInterval = interval;
        }
        // add by thomasmeng end--- 2014.08.13
